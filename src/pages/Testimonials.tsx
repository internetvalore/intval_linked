...
export default function Testimonials() {
  ...
  const content = language === 'it' ? {
    ...
    description: 'Scopri le storie di successo e le esperienze dei nostri clienti soddisfatti',
  } : {
    title: 'Testimonials',
    subtitle: 'What Our Clients Say',
    description: 'Discover the success stories and experiences of our satisfied clients',
  };
