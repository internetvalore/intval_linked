...
export default function RispondiSubito() {
  ...
  const content = language === 'it' ? {
    ...
    testCta: {
      ...
      description: 'Chiama il nostro numero verde 800 931 785 per testare il servizio e scoprire come funziona il nostro risponditore automatico.',
      button: 'Chiama Ora'
    },
    features: [
      {
    ...
    testCta: {
      ...
      description: 'Call our toll-free number 800 931 785 to test the service and discover how our automatic answering system works.',
      button: 'Call Now'
    },
    features: [
      {
