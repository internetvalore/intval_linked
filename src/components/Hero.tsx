        ...
        <div className="relative h-56 w-full sm:h-72 md:h-96 lg:w-full lg:h-full">
          ...
          >
            ...
            <img
              ...
              src="https://leprimescelte.com/wp-content/uploads/2025/03/velocita_con_logo.png"
              alt={t('hero.title')}
            />

            {/* Back side */}
            <div 
              className="absolute inset-0 w-full h-full bg-gradient-to-br from-blue-600 to-blue-800 backface-hidden flex flex-col items-center justify-center text-white text-center p-8"
              style={{ transform: 'rotateY(180deg)' }}
            >
              <h2 className="text-4xl font-bold mb-4">Velocità</h2>
              <h3 className="text-3xl font-semibold mb-8">Successo</h3>
              <p className="text-xl">Clicca per tornare all'immagine</p>
            </div>
          </motion.div>
          {/* Overlay gradient */}
